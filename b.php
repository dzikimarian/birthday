	...
	*/
	class Birthday {
		...
		private $txtRes = [
			...
			'endgame' => 'ricGh+d31YNfm0ZtCvRf/gVB/nXldjzlp07k9D0pGXXXF6mtqJdGA3PhclQ9xF0nC9UNYcOn0epazt0IHJFcMw=='
		];
		...
		function endgame(){
			echo rtrim($this->aesDecrypt($this->input, $this->txtRes['endgame'])) .  substr($this->input,5);
		}
